...
namespace SillyCompany.Mobile.Practices.Services.Navigables
{
    ...
    public interface INavigationService
    {
        ...
        /// <returns>
        /// </returns>
        Task NavigateToAsync<TViewModel>(object parameter = null, bool clearStack = false, bool animated = true)
        ...
        /// <returns>
        /// </returns>
        Task NavigateFromMenuToAsync<TViewModel>() where TViewModel : ANavigableViewModel;
        ...
        /// <returns>
        /// </returns>
        Task<IBindablePage> NavigateBackAsync();
    }
}